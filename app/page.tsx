    ...
    <main className="flex flex-col items-center justify-between pb-40">
      <div className="absolute top-5 hidden w-full justify-between px-5 sm:flex">
        ...
        <button
          ...
          className="rounded-lg bg-black p-2 text-white transition-colors duration-200 hover:bg-gray-800 sm:bottom-auto"
        >
          New Chat
        </button>
        <a
      ...
      {messages.length > 0 ? (
        ...
        >
          ...
          {/* Example buttons wrap below the bot's response */}
          {message.role === "assistant" && (
            <div className="flex flex-col space-y-4 border-t border-gray-200 bg-gray-50 my-2 p-7 sm:p-10 w-full max-w-screen-md">
